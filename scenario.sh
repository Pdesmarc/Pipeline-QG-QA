...
python ${DATA_DIR}/extraction_answer.py -t $1 -o ${DATA_DIR}
...
python ${DATA_DIR}/bert_anwser.py -t ${DATA_DIR}/result_Text_Answer.txt -q ${DATA_DIR}/questions_generated.txt -o ${DATA_DIR}
